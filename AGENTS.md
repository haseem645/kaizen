...
- On Check-in description list cards, keep the rating row centered, the camera action centered in a separate bottom row, and the type tag at the bottom-right. Single-description details must retain previous/next arrows beside `Page X of Y`, with arrows disabled at the first and last pages.
