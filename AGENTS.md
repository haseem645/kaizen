...
- Keep View Lesson visually aligned with Edit Training by sharing its bottom navigation, video layout, and quiz cards. Allow Video, SOP, Quiz, and Assignment tabs for every selected lesson, including public lessons and child organisations. The viewer must not expose create, edit, delete, upload, generation, formatting, or submission actions, even to managers.
