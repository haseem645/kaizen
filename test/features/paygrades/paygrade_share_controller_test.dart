...
import 'package:sparrowkaizen/features/paygrades/presentation/providers/paygrade_share_controller.dart';

void main() {
  TestWidgetsFlutterBinding.ensureInitialized();
  late _UseCase useCase;
  late PaygradeShareController controller;
  setUp(() async {
    ...
    useCase = _UseCase();
    controller = PaygradeShareController(useCase, jobId: 'job-id');
  });
  tearDown(() {
    controller.dispose();
    AppManager.instance.resetSessionState();
  ...
  test(
    ...
    () async {
      final closingController = PaygradeShareController(
        useCase,
        jobId: 'job-id',
      );
...
const _link = 'https://dev.kaizenteams.ai/shared/paygrades/public-id';
