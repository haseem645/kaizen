...
class TrainingLibrarySelectionSheet extends StatelessWidget {
  const TrainingLibrarySelectionSheet({
    super.key,
    required this.child,
    this.isBusy = false,
...
class TrainingLibrarySelectionHeader extends StatelessWidget {
  const TrainingLibrarySelectionHeader({
    super.key,
    required this.title,
...
class TrainingLibrarySelectionHeading extends StatelessWidget {
  const TrainingLibrarySelectionHeading({
    super.key,
    required this.title,
...
class TrainingLibrarySelectionTile extends StatelessWidget {
  const TrainingLibrarySelectionTile({
    super.key,
    required this.title,
...
class TrainingLibrarySelectionError extends StatelessWidget {
  const TrainingLibrarySelectionError({super.key, required this.message});
