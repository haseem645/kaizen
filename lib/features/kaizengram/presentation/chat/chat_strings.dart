class KaizengramChatStrings {
  KaizengramChatStrings._();
  ...
  static const String addPeopleEmailLabel = 'Email Address';
  static const String addPeopleEmailHint = 'Enter email address';
  static const String addPeopleConfirm = 'Done';
  ...
  static String addPersonTitle(String channelName) {
    return 'Add Person to #$channelName';
  }
