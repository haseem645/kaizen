...
class CheckInMediaCommentsBottomSheet extends StatefulWidget {
  ...
  @override
  State<CheckInMediaCommentsBottomSheet> createState() =>
      _CheckInMediaCommentsBottomSheetState();
}

class _CheckInMediaCommentsBottomSheetState
    extends State<CheckInMediaCommentsBottomSheet> {
  ...
  void initState() {
    ...
    _viewState.value = _viewState.value.copyWith(
      isUploadingMedia: CheckInMediaUploadController.instance
  ...
  Future<void> _enqueueSelectedVideoUpload(
    ...
    _updateViewState(_viewState.value.copyWith(isUploadingMedia: false));
    final message = CheckInMediaUploadController.instance.startErrorMessage
        ?.trim();
  ...
  Future<void> _syncAuditMediaUploadState() async {
    ...
    final isUploadingMedia = CheckInMediaUploadController.instance
        .isUploadActiveForAuditMedia(widget.selectedMedia.uuid);
